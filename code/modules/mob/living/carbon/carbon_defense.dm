...
=======
	...
	if(check_zone(M.zone_selected) == BODY_ZONE_L_ARM || check_zone(M.zone_selected) == BODY_ZONE_R_ARM) //Headpats are too extreme, we have to pat shoulders on yogs
...
>>>>>>> 3479328ff6a... wej cant code :^) (#10399)
	else
