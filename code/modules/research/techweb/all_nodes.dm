...
>>>>>>> a25d418ce5f... Adds the ability to construct the floor igniter (#10536)
...
/datum/techweb_node/adv_mining
	...
	design_ids = list("drill_diamond", "jackhammer", "hypermod", "plasmacutter_adv", "borg_upgrade_plasmacutter", "mining_bot")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
